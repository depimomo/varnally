            ...
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-4 space-y-6">
                  ...
                  {/* Your Varna Section - Moved & Highlighted */}
                  {archetypes.color_archetypes[result.season]?.[`${result.subType} ${result.season}`] && (
                    <motion.div 
                      ...
                      <div className="relative z-10 space-y-4">
                        ...
                        <div>
                          <h3 className="text-3xl font-display font-black leading-tight">
                            {archetypes.color_archetypes[result.season][`${result.subType} ${result.season}`].nickname}
                          </h3>
                        </div>

                        <p className="text-sm font-medium text-white/90 leading-relaxed italic">
                          "{archetypes.color_archetypes[result.season][`${result.subType} ${result.season}`].description}"
                        </p>
