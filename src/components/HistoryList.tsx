  ...
  return (
    ...
    >
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-3xl font-display font-bold text-gray-900">Saved Varna</h1>
      </div>
          ...
          {history.map((item) => (
            ...
            >
              <button 
                ...
                className="absolute top-2 right-2 p-2.5 text-gray-400 hover:text-red-500 hover:bg-rose-50 transition-all z-30 bg-white shadow-sm rounded-full border border-gray-100 cursor-pointer"
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-50">
                ...
                <button 
                  onClick={() => onView(item)}
                  className="text-brand-secondary text-sm font-bold flex items-center gap-1 hover:underline cursor-pointer"
                >
                  View Full Result
                </button>
              </div>
            ...
            >
              ...
              <div className="flex flex-col gap-2.5">
                <button
                  ...
                  className="w-full py-3 bg-red-500 hover:bg-red-600 text-white rounded-2xl font-bold text-xs tracking-widest uppercase transition-all shadow-md shadow-red-500/10 cursor-pointer active:scale-98"
                >
                  Yes, Delete Item
                </button>
                <button
                  onClick={() => setDeleteItemId(null)}
                  className="w-full py-3 bg-gray-50 hover:bg-gray-150 text-gray-600 rounded-2xl font-bold text-xs tracking-widest uppercase transition-all border border-gray-100 cursor-pointer active:scale-98"
                >
                  Cancel
                </button>
              </div>
              ...
              <button 
                onClick={() => setDeleteItemId(null)}
                className="absolute top-4 right-4 text-gray-400 hover:text-gray-600 cursor-pointer p-1 rounded-full hover:bg-gray-50 transition-all"
              >
                <X size={16} />
              </button>
            </motion.div>
